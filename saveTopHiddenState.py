...
# CUDA_VISIBLE_DEVICES=1 python saveTopHiddenState.py --model_type "bert" --model_name_or_path "./models/bert-base-uncased_sst2_10epochs/" --mlm --mlm_probability 0.15 --per_device_train_batch_size=64 --per_device_eval_batch_size 64 --block_size 150 --line_by_line --train_data_file "./dataset/SST2/train.csv" --eval_data_file "./dataset/SST2/dev.csv" --output_dir "./results/bert-base-uncased_sst2_10epochs/"
# CUDA_VISIBLE_DEVICES=1 python saveTopHiddenState.py --model_type "bert" --model_name_or_path "./models/bert-base-uncased_trec_10epochs/" --mlm --mlm_probability 0.15 --per_device_train_batch_size=64 --per_device_eval_batch_size 64 --block_size 150 --line_by_line --train_data_file "./dataset/TREC/train.csv" --eval_data_file "./dataset/TREC/dev.csv" --output_dir "./results/bert-base-uncased_trec_10epochs/"
# CUDA_VISIBLE_DEVICES=0 python saveTopHiddenState.py --model_type "roberta" --model_name_or_path "./models/roberta-base_sst2_10epochs/" --mlm --mlm_probability 0.15 --per_device_train_batch_size=64 --per_device_eval_batch_size 64 --block_size 150 --line_by_line --train_data_file "./dataset/SST2/train.csv" --eval_data_file "./dataset/SST2/dev.csv" --output_dir "./results/roberta-base_sst2_10epochs/"
# CUDA_VISIBLE_DEVICES=0 python saveTopHiddenState.py --model_type "roberta" --model_name_or_path "./models/roberta-base_trec_10epochs/" --mlm --mlm_probability 0.15 --per_device_train_batch_size=64 --per_device_eval_batch_size 64 --block_size 150 --line_by_line --train_data_file "./dataset/TREC/train.csv" --eval_data_file "./dataset/TREC/dev.csv" --output_dir "./results/roberta-base_trec_10epochs/"
# CUDA_VISIBLE_DEVICES=0 python saveTopHiddenState.py --model_type "xlm-roberta" --model_name_or_path "./models/xlm-roberta-base_sst2_10epochs/" --mlm --mlm_probability 0.15 --per_device_train_batch_size=8 --per_device_eval_batch_size 8 --block_size 150 --line_by_line --train_data_file "./dataset/SST2/train.csv" --eval_data_file "./dataset/SST2/dev.csv" --output_dir "./results/xlm-roberta-base_sst2_10epochs/"
# CUDA_VISIBLE_DEVICES=0 python saveTopHiddenState.py --model_type "xlm-roberta" --model_name_or_path "./models/xlm-roberta-base_trec_10epochs/" --mlm --mlm_probability 0.15 --per_device_train_batch_size=8 --per_device_eval_batch_size 8 --block_size 150 --line_by_line --train_data_file "./dataset/TREC/train.csv" --eval_data_file "./dataset/TREC/dev.csv" --output_dir "./results/xlm-roberta-base_trec_10epochs/"
# CUDA_VISIBLE_DEVICES=0 python saveTopHiddenState.py --model_type "bert" --model_name_or_path "./models/bert-base-uncased_multi30k_10epochs/" --mlm --mlm_probability 0.15 --per_device_train_batch_size=64 --per_device_eval_batch_size 64 --block_size 150 --line_by_line --train_data_file "./dataset/multi30k/multi30k_train.txt" --eval_data_file "./dataset/multi30k/multi30k_test.txt" --output_dir "./results/bert-base-uncased_multi30k_10epochs/"
# CUDA_VISIBLE_DEVICES=1 python saveTopHiddenState.py --model_type "roberta" --model_name_or_path "./models/roberta-base_multi30k_10epochs/" --mlm --mlm_probability 0.15 --per_device_train_batch_size=64 --per_device_eval_batch_size 64 --block_size 150 --line_by_line --train_data_file "./dataset/multi30k/multi30k_train.txt" --eval_data_file "./dataset/multi30k/multi30k_test.txt" --output_dir "./results/roberta-base_multi30k_10epochs/"
# CUDA_VISIBLE_DEVICES=1 python saveTopHiddenState.py --model_type "xlm-roberta" --model_name_or_path "./models/xlm-roberta-base_multi30k_10epochs/" --mlm --mlm_probability 0.15 --per_device_train_batch_size=8 --per_device_eval_batch_size 8 --block_size 150 --line_by_line --train_data_file "./dataset/multi30k/multi30k_train.txt" --eval_data_file "./dataset/multi30k/multi30k_test.txt" --output_dir "./results/xlm-roberta-base_multi30k_10epochs/"
